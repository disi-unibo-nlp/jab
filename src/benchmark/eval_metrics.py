...
def parse_arguments():
    ...
    parser.add_argument("--junit_test_path", type=str, default="out/completions/Qwen2.5-Coder-7B-Instruct/cot/pass10/2025-04-03_11-10-59/junit_results.jsonl", help="Model's HF directory or local path")
...
if __name__ == "__main__":
    ...
    print(f"Mean compilation@{k}:", compilation_k)
    print(f"Mean pass@{k}:", pass_k)
